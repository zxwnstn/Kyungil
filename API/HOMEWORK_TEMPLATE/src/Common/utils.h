...
namespace UTIL
{
	...
	void DrawColorRect(HDC hdc, const RECT& rect, bool _clearEdge = false, COLORREF color = RGB(0, 0, 0));
	...
	void DrawColorRect(HDC hdc, const UTIL::IRECT& rect, bool _clearEdge = false, COLORREF color = RGB(0, 0, 0));
